...
namespace Drupal\commerce_promotion_api\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'commerce_promotion_api_end_datetime' widget.
 *
 * @FieldWidget(
 *   id = "commerce_promotion_api_end_datetime",
 *   label = @Translation("End datetime"),
 *   field_types = {
 *     "datetime"
 *   }
 * )
  ...
  public function massageFormValues(array $values, array $form, FormStateInterface $form_state) {
    foreach ($values as &$item) {
      if (!empty($item['container']['value']) && $item['container']['value'] instanceof DrupalDateTime) {
        ...
        $item['value'] = $date->format(\Drupal\datetime\Plugin\Field\FieldType\DateTimeItemInterface::DATETIME_STORAGE_FORMAT);
